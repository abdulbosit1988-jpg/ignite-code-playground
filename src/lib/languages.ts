...
export const LANGUAGES: { key: LangKey; name: string; ext: string; color: string; icon: string; runnable: boolean; starter: string }[] = [
  {
    key: "python", name: "Python", ext: "py", color: "text-syntax-blue", icon: "🐍", runnable: true,
    starter: `# Привет, Python!\nprint("Hello, World!")\nfor i in range(3):\n    print(f"i = {i}")\n`,
  },
  {
    key: "html", name: "HTML", ext: "html", color: "text-syntax-orange", icon: "🌐", runnable: true,
  ...
  {
    key: "javascript", name: "JavaScript", ext: "js", color: "text-syntax-yellow", icon: "⚡", runnable: true,
    starter: `// Hello, JS!\nconsole.log("Hello, World!");\nfor (let i = 0; i < 3; i++) console.log("i =", i);\n`,
  },
  {
    key: "go", name: "Go", ext: "go", color: "text-syntax-blue", icon: "🐹", runnable: false,
